...
import { SavesStorage } from './SavesStorage';
const VERSION = 1;
const SAVES_ID = 'saves';
const NEW_SAVE = 'NEW_SAVE';
class SavesPlugin extends Phaser.Plugins.BasePlugin {
  constructor(pluginManager) {
    super(pluginManager);

    this.saves = {};
    this._storage = new SavesStorage(SAVES_ID);
    this._storage.plugin = new StoragePlugin();
  }
